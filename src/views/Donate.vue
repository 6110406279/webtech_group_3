<template>
  <div>
    <div class="container-fluid">
      <div style="background-color: #43658b;padding:30px 0 30px 50px" class="row">
        <h1 style="color:white">บริจาค: กรุงเทพมหานคร</h1>
      </div>
      <div class="row" style="background-color: #4e89ae;padding:10px 0 10px 50px">
    ...
    <h3 style="color:red">กรุงเทพมหานคร</h3>
