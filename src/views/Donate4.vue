<template>
  <div>
    <div class="container-fluid">
      <div style="background-color: #056676;padding:30px 0 30px 50px" class="row">
        <h1 style="color:white">บริจาค: จังหวัดเชียงใหม่</h1>
      </div>
      <div class="row" style="background-color: #5eaaa8;padding:10px 0 10px 50px">
